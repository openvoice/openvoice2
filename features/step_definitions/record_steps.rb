...
Then /^a call should be initiated from user's openvoice address to "([^"]*)"$/ do |endpoint_address|
  Jobs::RecordGreeting.should have_queued(my.address, endpoint_address)
end
